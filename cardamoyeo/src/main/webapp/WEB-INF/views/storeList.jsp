					...
					<div class="col-md-7">
						...
						<div class="custom-breadcrumbs">
							<a href="index">Home</a> <span class="mx-2 slash">/</span> <a
								href="myPage">업체 마이페이지</a> <span class="mx-2 slash">/</span> <span
					...
					<div class="col-lg-9">
						<div class="row mb-5 justify-content-center">
							<div class="col-md-7 text-center">
								<h2 class="section-title mb-2">매장 관리</h2>
							</div>
						</div>
								...
								<c:if test="${!empty list }">
									<c:forEach items="${list }" var="store" varStatus="status">
										<tr align="center" valign="middle" bordercolor="#333333"
											...
											<td height="23" style="font-family: Tahoma; font-size: 10pt;">${status.count}
