        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="custom-breadcrumbs">
              ...
              <a href="userMypage">마이페이지</a> <span class="mx-2 slash">/</span>
    ...
    <section class="site-section">
       <div class="container">
		 ...
		 <div class="col-lg-9">
          ...
          <div class="row mb-5">
            <div class="col-lg-12">
              <form action="updateownerInfo?user_id=${user_id} " method="post" class="p-4 p-md-5 border rounded" >
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="store_license_number" name="store_license_number" value="${udto.store_license_number }" readonly/>
              	</div>
              	
              	
              	<div class="form-group">
                  <label for="company-website-tw d-block">사업자등록 파일</label> <br>
                  <input type="text" class="form-control" name="store_license_image" id="store_license_image" value="${udto.store_license_image }" readonly>
              	</div>
