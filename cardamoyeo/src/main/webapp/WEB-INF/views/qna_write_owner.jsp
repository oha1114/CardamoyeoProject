					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<form role="form" action="qna_view_owner" method="post" id="frm">
									<div class="form-check">
									    <label class="form-check-label">
											<!-- <input class="form-check-input" type="checkbox" name='user_id' id='user_id' checked>사용자 -->
											<!-- <input type="text" class="form-control" name='user_id' id='user_id' placeholder="업체"> -->
											<sec:authentication property="principal.username" var="user_Id"/>
									...
									<div class="text-center">
										...
										<button type="reset" class="btn btn-outline btn-danger"><a href="qna_list_owner" class="text-white">취소</a></button>
									</div>
								</form>
							</div>
						</div>
