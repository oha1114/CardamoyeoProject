        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="custom-breadcrumbs">
              ...
              <span class="text-white"><strong>My 관심등록</strong></span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            <div class="row mb-5 justify-content-center">
                ...
                <h2 class="section-title mb-2">My 관심등록</h2>
              </div>
            </div>
		    ...
		    <div>
			  <table class="table table-hover">
				...
				<c:if test="${!empty ha}">
				  <c:forEach items="${ha }" var="like" varStatus="status">
				    <tr align="center" valign="middle" bordercolor="#333333"
					 ...
					 <td style="font-family:Tahoma;font-size:10pt;">
					   <div align="center">
						 ...
						 <a href="storeDetail?store_seq=${like.SDto.store_seq }&user_id=${user_id}">
							${like.SDto.store_name }
						 </a>
					   </div>
					 </td>
					 ...
					 <td style="font-family:Tahoma;font-size:10pt;">
					   <div align="center">
						 <fmt:formatDate value="${like.like_regdate }" type="date" pattern="yyyy-MM-dd"/>
					   </div>
					 </td>	
					 <td><a href="delete?like_list_seq=${like.like_list_seq}&user_id=${user_id}" onclick="return alert('관심등록 해제되었습니다.');" class="btn btn-primary btn-xs">해제</a></td>
				  </tr>
				 </c:forEach>
