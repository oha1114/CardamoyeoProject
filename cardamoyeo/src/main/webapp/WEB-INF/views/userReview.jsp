        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="custom-breadcrumbs">
              ...
              <span class="text-white"><strong>My 리뷰</strong></span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            <div class="row mb-5 justify-content-center">
                ...
                <h2 class="section-title mb-2">My 리뷰</h2>
              </div>
            </div>
		    ...
		    <div>
			  <table class="table">
				...
				<c:if test="${!empty list }">
				  <c:forEach items="${list }" var="rv" varStatus="status">
				    <tr align="center" valign="middle" bordercolor="#333333"
						onmouseover="this.style.backgroundColor='F8F8F8'"
						onmouseout="this.style.backgroundColor=''">
					 <td height="23" style="font-family:Tahoma;font-size:10pt;" rowspan="2">
					    ${status.count} <!-- index : 0 ~ , count : 1 ~ -->
					 </td>
					 <td style="font-family:Tahoma;font-size:10pt;">
					   <div align="center">
						 <a href="storeDetail?store_seq=${rv.SDto.store_seq}&user_id=${user_id}" style="font-size:15px;">
							${rv.SDto.store_name }
						 </a> &nbsp;
						 <c:if test="${rv.store_star == 1}">
							<img src="images/star_1.PNG">
						 </c:if> 
						 <c:if test="${rv.store_star == 2}">
							<img src="images/star_2.PNG">
						 </c:if> 
						 <c:if test="${rv.store_star == 3}">
							<img src="images/star_3.PNG">
						 </c:if> 
						 <c:if test="${rv.store_star == 4}">
							<img src="images/star_4.PNG">
						 </c:if> 
						 <c:if test="${rv.store_star == 5}">
							<img src="images/star_5.PNG">
						 </c:if> <br/>
						 ${rv.review_content }
					   </div>
					 </td>
					 <td style="font-family:Tahoma;font-size:10pt;" rowspan="2">
					   <div align="center">
						 <fmt:formatDate value="${rv.review_date }" type="date" pattern="yyyy-MM-dd"/>
					   </div>
					 </td>	
					 <td rowspan="2"><a href="reviewDel?review_seq=${rv.review_seq}&user_id=${user_id}" onclick="return alert('삭제되었습니다.');" 
					 	class="btn btn-primary btn-xs">삭제</a>
					 </td>
					</tr>
					<tr align="center">
					</tr>
