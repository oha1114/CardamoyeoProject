...
<div class="site-wrap">
        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="custom-breadcrumbs">
              ...
              <span class="text-white"><strong>본인확인</strong></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h2 class="mb-4">본인확인</h2>
            <form action="userInfo" method="post" id="infoForm" class="p-4 border rounded">
            ...
            <div class="col-lg-3 ml-auto mt-2">
			  	<button type="button" id="submit" class="btn btn-primary btn-md">확인</button>
			  	<button type="button" class="cencle btn btn-primary btn-md">취소</button>
			</div>
			<div>
				<c:if test="${msg == false}">
					비밀번호가 맞지 않습니다.
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".cencle").on("click", function(){
				...
				location.href = "${pageContext.request.contextPath}/userMypage";
