      ...
      <div class="container-fluid">
		...
		<!-- HOME -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7">
						<h1 class="text-white font-weight-bold">업체 마이페이지</h1>
						<div class="custom-breadcrumbs">
							<a href="index">Home</a> <span class="mx-2 slash">/</span> <a
								href="storeList">업체 마이페이지</a> <span class="mx-2 slash">/</span> <span
								class="text-white"><strong>매장 관리</strong></span>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="site-section">
			<div class="container">
				<div class="row">
				<jsp:include page="sidebar_owner.jsp" />
				
			
					<div class="col-lg-9">
						<div class="row mb-5 justify-content-center">
							<div class="col-md-7 text-center">
						<h2 class="section-title mb-2">예약 내역</h2>
					</div>
				</div>
			<c:forEach var="ur" items="${list}" varStatus="status">
				<ul class="job-listings mb-5">
					
						<li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
							<!-- 클릭하면 해당 유저의 결제 내역 -->
							<a href="resPay?res_seq=${ur.pdto.res_seq }&user_id=${ur.pdto.user_id}"></a>
							...
							<div
								...
								<div class="job-listing-position custom-width w-50 mb-3 mb-sm-0">
									...
									<h2>${ur.pdto.user_id}</h2>
									<strong>${ur.pdto.car_num} </strong>&nbsp;&nbsp; <strong>이용시간 </strong>&nbsp;&nbsp; <strong> <fmt:formatDate value="${ur.pdto.res_date}" type="date" pattern="yyyy-MM-dd"/> 
									</strong>
								</div>
								<div class="job-listing-location mb-3 mb-sm-0 custom-width w-25">
									<span class="icon-room"></span>${ur.store_seq}
								</div>
								<div class="job-listing-meta">
									<span class="badge badge-danger">결제완료</span>
									<fmt:formatDate value="${ur.pdto.pay_date}" type="date" pattern="yy-MM-dd"/> 
								</div>
							</div>
						</li>
