 ...
 <!-- NAVBAR -->
    <header class="site-navbar mt-3">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold"><a href="qna_go" class="text-white">Q&A</a></h1>
			...
			<div class="row align-items-center mb-5">
				<div class="col-lg-12 mb-4 mb-lg-0">
					<div class="align-items-center" >
						<div>
							<h2>Q&A 바로 가기</h2><br/><br/>
							<div class="row" align="center">
								<div class="col-6 col-md-6 col-lg-6 mb-4 mb-lg-5">
						            <a href="qna_list" class="block__16443 text-center d-block">
						              <span class="custom-icon mx-auto"><span class="icon-magnet d-block"></span></span>
						              <h3>사용자</h3>
						            </a>
								</div>
								<div class="col-6 col-md-6 col-lg-6 mb-4 mb-lg-5">           
									<a href="qna_list_owner" class="block__16443 text-center d-block">
				...
				<!-- <button class="btn btn-primary btn-lg btn-block" id="userbtn"><a href="qna_list" class="text-white">사용자</a></button>
				<button class="btn btn-primary btn-lg btn-block" id="ownerbtn"><a href="qna_list_owner" class="text-white">업체</a></button> -->	
			</div>
		</div>
	</section>
