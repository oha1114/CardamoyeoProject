...
<div class="site-wrap">
	...
	<section class="site-section">
		<div class="container">
			...
			<form name="deleteForm" action="qna_detail_owner" method="post">
				<input type="hidden" name="board_seq" id="board_seq" value="${param.board_seq}">			
				<font size=2>글 비밀번호 : </font> 
				<input name="board_pass" type="password">
				<button type="submit" data-oper="remove" class="btn btn-outline btn-primary">글보기</button>
			<!-- <button type="submit" data-oper="remove" class="btn btn-outline btn-primary"><a href="qna_view" class="text-white">글보기</a></button> -->
				<button type="submit" data-oper="list" class="btn btn-outline btn-primary"><a href="qna_list_owner" class="text-white">목록보기</a></button>${msg}
			</form>
		</div>
	</section>
