...
<div class="site-wrap">
	...
	<section class="section-hero overlay inner-page bg-image" style="background-image: url('images/bg_parking.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold"><a href="qna_list_owner" class="text-white">Q&A</a></h1>
     ...
     <section class="site-section">
		...
		<div class="container" id="frm">
			...
			<div class="text-center">
				<button type="submit" data-oper="list" class="btn btn-outline btn-primary"><a href="qna_list_owner" class="text-white">목록</a></button>
					<sec:authorize access="isAuthenticated()">
						<sec:authorize access="hasAuthority('ROLE_O')">
							...
							<button type="submit" id="modify" class="btn btn-outline btn-primary"><a href="qna_modify_owner?board_seq=${dto.board_seq }" class="text-white">수정</a></button>
						</sec:authorize>
					</sec:authorize>
			</div>
		</div><br/>
...
<!-- 댓글 작성 -->
			<div>
			<sec:authorize access="hasAuthority('ROLE_M')">
				<form action="replyWrite_owner" method="post">    
				...
				<div id="listReply" class="container-fluid" align="right">
					<table class="table table-bordered" cellpadding="0" cellspacing="0">
							<c:forEach var="dto" items="${oreplyList}">
								<tr>
									<td>
										...
										<div>
											<button type="button" class="btn btn-outline btn-primary"><a href="replyDeleteView_owner?reply_seq=${dto.reply_seq}" class="text-white">삭제</a></button>
										</div>	
									</td>
								</tr>	
							</c:forEach>						
...
<jsp:include page="footer.jsp" />
	...
	<script>
		function qnaDeleteConfirm(){
			...
			if(isDelete){
				location.href="qna_delete_owner?seq=${dto.board_seq}"
			}
		}
	</script>
