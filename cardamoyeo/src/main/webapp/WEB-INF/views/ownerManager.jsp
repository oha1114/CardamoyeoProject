		...
		<div class="col-lg-12">	
			...
			<thead>
				<tr>
					...
					<th class="text-center">사업자등록승인</th>
			...
			<c:forEach items="${list}" var="dto">
							<tr>
								...
								<td class="text-center"><a href="storeList?user_id=${dto.user_id }">${dto.user_name}</a></td>
								...
								<td class="text-center">${dto.owner_ok}</td>
								<td class="text-center"><button class="btn btn-outline btn-primary"><a href="OwnerDelete?user_num=${dto.user_num}" class="text-white">삭제</a></button></td>
							</tr>
